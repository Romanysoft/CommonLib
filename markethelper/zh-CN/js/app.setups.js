...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    _U.loadTemplate = function(cb){
        $.templateLoader.loadExtTemplate("markethelper/zh-CN/templates/tpl.app.setup.htm", function(){
            cb && cb();
        })
    };
    ...
    _U.launch = function () {
        ...
        _U.loadTemplate(function(){
            ...
            if (!win.data("kendoWindow")){
                ...
                $.getScript("data/zh-CN/marking_setup.js").done(function(data, textStatus, jqxhr){
                    var dataList = [];
