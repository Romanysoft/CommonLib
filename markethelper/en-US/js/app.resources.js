...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    _U.loadTemplate = function(cb){
        $.templateLoader.loadExtTemplate("markethelper/zh-CN/templates/tpl.app.resources.htm", function(){
            cb && cb();
        })
    };
    ...
    _U.launch = function () {
        ...
        _U.loadTemplate(function(){
            ...
            if (!win.data("kendoWindow")){
                ...
                var url = "data/zh-CN/google_blogger_analytics_ass.js" + "?t=" + (new Date()).getTime();
