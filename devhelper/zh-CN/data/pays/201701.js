(function () {
   ...
   try{
      ...
      if(1){
         ...
         endDate = 20170123;
         curE = 6.85592;
         _U.data.push(_U.tp({id: "D1150418", cost: 22.7, rate: curE, start:nowDate, end:endDate}));
         _U.data.push(_U.tp({id: "D2150425", cost: 56.3, rate: curE, start:nowDate, end:endDate}));
         _U.data.push(_U.tp({id: "D3150522", cost: 16.7, rate: curE, start:nowDate, end:endDate}));
         _U.data.push(_U.tp({id: "D4150728", cost: 31.1, rate: curE, start:nowDate, end:endDate}));
         _U.data.push(_U.tp({id: "D5150916", cost: 13.9, rate: curE, start:nowDate, end:endDate}));
         _U.data.push(_U.tp({id: "D6151112", cost: 32.7, rate: curE, start:nowDate, end:endDate}));
         _U.data.push(_U.tp({id: "D7151202", cost: 15.4, rate: curE, start:nowDate, end:endDate}));

         _U.data.push(_U.tp({id: "D13161027", cost: 0.6, rate: curE, start:nowDate, end:endDate}));
      }
      ...
      if(1){
         ...
         endDate = 20170124;
         curE = 6.87676;
         _U.data.push(_U.tp({id: "D1150418", cost: 13.2, rate: curE, start:nowDate, end:endDate}));
         _U.data.push(_U.tp({id: "D2150425", cost: 11.7, rate: curE, start:nowDate, end:endDate}));
         _U.data.push(_U.tp({id: "D3150522", cost: 9.3, rate: curE, start:nowDate, end:endDate}));
         _U.data.push(_U.tp({id: "D4150728", cost: 12.4, rate: curE, start:nowDate, end:endDate}));
         _U.data.push(_U.tp({id: "D5150916", cost: 4.6, rate: curE, start:nowDate, end:endDate}));
         _U.data.push(_U.tp({id: "D6151112", cost: 3.5, rate: curE, start:nowDate, end:endDate}));
      ...
      if(1){
         ...
         endDate = 20170127;
         curE = 6.87869;
         _U.data.push(_U.tp({id: "D1150418", cost: 52.7, rate: curE, start:nowDate, end:endDate}));
         _U.data.push(_U.tp({id: "D2150425", cost: 23.4, rate: curE, start:nowDate, end:endDate}));
         _U.data.push(_U.tp({id: "D3150522", cost: 19.8, rate: curE, start:nowDate, end:endDate}));
         _U.data.push(_U.tp({id: "D4150728", cost: 26.4, rate: curE, start:nowDate, end:endDate}));
         _U.data.push(_U.tp({id: "D5150916", cost: 19.7, rate: curE, start:nowDate, end:endDate}));
         _U.data.push(_U.tp({id: "D6151112", cost: 28.5, rate: curE, start:nowDate, end:endDate}));
         _U.data.push(_U.tp({id: "D7151202", cost: 31.7, rate: curE, start:nowDate, end:endDate}));
      }
      ...
      if(1){
         ...
         _U.data.push(_U.tp({id: "D14161027", cost: 0.64, rate: curE, start:nowDate, end:endDate}));
         _U.data.push(_U.tp({id: "D10161024", cost: 0.72, rate: curE, start:nowDate, end:endDate}));
      }
