(function () {
   ...
   try{
      ...
      if(1){
         ...
         endDate = 20161231;
         curE = 6.94464;
         _U.data.push(_U.tp({id: "D1150418", cost: 42.17, rate: curE, start:nowDate,  end:nowDate}));
         _U.data.push(_U.tp({id: "D2150425", cost: 46.29, rate: curE, start:nowDate,  end:nowDate}));
         _U.data.push(_U.tp({id: "D3150522", cost: 17.24, rate: curE, start:nowDate, end:nowDate}));
         _U.data.push(_U.tp({id: "D4150728", cost: 35.14, rate: curE, start:nowDate,  end:nowDate}));
         _U.data.push(_U.tp({id: "D5150916", cost: 27.67, rate: curE, start:nowDate,  end:nowDate}));
         _U.data.push(_U.tp({id: "D6151112", cost: 29.17, rate: curE, start:nowDate, end:nowDate}));
         _U.data.push(_U.tp({id: "D7151202", cost: 19.23, rate: curE, start:nowDate, end:nowDate}));
